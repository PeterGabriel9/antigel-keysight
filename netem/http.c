...
"  }catch(e){}"
"}"
"function inp(pq,f,v,cls){"
"  const id='i-'+pq+'-'+f;"
"  const el=document.getElementById(id);"
"  if(el&&document.activeElement===el)return el.outerHTML;"
"  return '<input id=\"'+id+'\" class=\"cfg '+cls+'\" type=\"number\" min=\"0\" value=\"'+v+'\" '"
...
"      +'<td class=\"pq-pkts\">'+fmt(q.pkt_count)+'</td>'"
"      +'<td><div class=\"cfg-wrap\">'+inp(q.id,'drop_n',q.drop_n,'f-drop')+'<span class=\"cfg-unit\">/ 10</span></div></td>'"
"      +'<td><div class=\"cfg-wrap\">'+inp(q.id,'dup_n',q.dup_n,'f-dup')+'<span class=\"cfg-unit\">/ 10</span></div></td>'"
"      +'<td><div class=\"cfg-wrap\">'+inp(q.id,'delay_us',q.delay_us,'f-dly')+'<span class=\"cfg-unit\">&micro;s</span></div></td>'"
"      +'<td><div class=\"dq-wrap\"><div class=\"dq-bar\"><div class=\"dq-fill\" style=\"width:'"
"        +Math.min(100,q.dq_depth/20.48)+'%\"></div></div>'"
"        +'<span class=\"dq-num\">'+q.dq_depth+'</span></div></td>'"
"      +'</tr>'"
"    ).join('');"
"  }catch(e){"
